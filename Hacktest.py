...
from html_temp import css, bot_temp, user_temp  # Ensure html_temp.py is in the same directory or the correct path is provided
...
def get_conversation_chain(vectorstore):
    llm = HuggingFaceHub(repo_id="mistralai/Mistral-7B-Instruct-v0.3", model_kwargs={"temperature": 0.3},huggingfacehub_api_token=HUGGINGFACEHUB_API_TOKEN)
